...
export default function Button (props:any){
    ...
    const width = props.width === "Big" ? "224px" : "100px"

    return(
        <div className="flex justify-center ">
            <button style={{ width:width }} className={`text-white flex justify-center items-center space-x-1 font-[Maharlika] uppercase text-[15px]  h-[50px] buttonToBorder`}>
                    ...
                    <p className="h-[15px]">{props.title}</p>
