...
export default function Button (props:any){
    ...
    return(
        <div className="flex justify-center relative">
            <Link href={href} className="text-white flex justify-center items-center space-x-1 font-[Maharlika] uppercase buttonToBorder glow-on-hover">
                    ...
                    <span className="glow"></span>
                    <span className="glow"></span>
                    <div className="h-[15px]">{props.title}</div>
