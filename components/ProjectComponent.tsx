    ...
    <div className='relative w-screen h-screen'> 
        <div className='flex md:items-center items-end h-screen md:p-0 pb-[25%]'>
            <div className='md:w-1/2 md:pl-[90px] md:pr-[0px] px-[50px]'>
                ...
                <p className='projectText my-[40px]'>{props.text}</p>
                <Link href="Animation">
...
{/* ABSOLUTE POSITIONS HERO SECTION // MENU */}
        <img className='w-[76%] absolute top-[50%] -translate-y-[100%] md:-translate-y-[50%] md:m-0 m-auto md:right-0 md:left-auto left-0 -z-[20] ' 
